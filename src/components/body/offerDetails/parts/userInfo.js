    ...
    <>
        <div className="col s12 center-align">
            ...
            <img height="100px" alt="Изображение пользователя" src={
                props.userPic.filePath? props.userPic.filePath
            ...
            <h5 className="noMarginPadding">{props.name} {props.lastName}</h5> 
                {props.userType?<span>{props.userType}<br/></span>:''}
                <br/>
            ...
            <div className="col s12">
                ...
                <br/><br/>
                {props.date_of_creation?<div className="col s12"><span className="fw-100">Дата регистрации:</span> {formatDate(props.date_of_creation.toDate(), 'noTime')}</div>:null}
